...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "9FF18"  # Playfab Title Id
        self.SecretKey: str = "ZS7N1RD3T855DHD81PTZYR8PRAPIOJFGEMGE4H8XZ3G9TY6Y47"  # Playfab Secret Key
        self.ApiKey: str = "OC|1210995498764300|4a1b03e3887bbe44b08bb38d06e2f692"  # App Api Key (Oculus/Graph API)
